        ...
        <div class="card-body">
            ...
            <table class="table">
                ...
                @foreach($allEmployeeRecords as $record)
                    <tr>
                        <th scope="row"><a href="/employee/records/details/{{$record->id}}"> {{$record->id}} </a></th>
                        <td><a href="/employee/records/details/{{$record->id}}">{{$record->title}}</a></td>
                        <td><a href="/employee/records/details/{{$record->id}}"><img style="width: 50px"
